...
export class SpatialHashGridFlat {
	...
	getCellIndex( position ) {
		...
		const x = Maths.sat( ( position[0] - this.bounds[0][0] ) / ( this.bounds[1][0] - this.bounds[0][0] ) );
		const y = Maths.sat( ( position[1] - this.bounds[0][1] ) / ( this.bounds[1][1] - this.bounds[0][1] ) );
		const z = Maths.sat( ( position[2] - this.bounds[0][2] ) / ( this.bounds[1][2] - this.bounds[0][2] ) );
