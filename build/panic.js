	...
	*/
	...
	class SpatialHashGrid {
		...
		getCellIndex( position ) {
			...
			const x = instance$d.sat( ( position[0] - this.bounds[0][0] ) / ( this.bounds[1][0] - this.bounds[0][0] ) );
			const y = instance$d.sat( ( position[1] - this.bounds[0][1] ) / ( this.bounds[1][1] - this.bounds[0][1] ) );
			const z = instance$d.sat( ( position[2] - this.bounds[0][2] ) / ( this.bounds[1][2] - this.bounds[0][2] ) );
		...
		newClient( position, dimensions ) {
			...
			const client = new Client$1( position, dimensions );
	...
	var dataStructures = /*#__PURE__*/Object.freeze({
		...
		SpatialHashGridFlat: SpatialHashGridFlat
	});
